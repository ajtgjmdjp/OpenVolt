...
PYBIND11_MODULE(_openvolt, m) {
    ...
    py::class_<ov::ObjectiveWeights>(m, "ObjectiveWeights")
        .def(py::init<>())
        .def_readwrite("tracking_error", &ov::ObjectiveWeights::tracking_error)
    ...
    py::class_<ov::Diagnostics>(m, "Diagnostics")
        ...
        .def_readonly("ex_ante_tracking_error", &ov::Diagnostics::ex_ante_tracking_error)
